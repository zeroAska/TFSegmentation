...
python -m tensorflow.python.tools.freeze_graph --input_graph graph.pb --input_checkpoint experiments/fcn8s_mobilenet/checkpoints/best/-8184 --output_graph graph_frozen.pb --output_node_names=network/output/ArgMax
